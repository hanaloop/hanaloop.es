...
import * as data from "../data/ko_platform.data";

<Hero background={{
    imageUrl: useBaseUrl('/images/bg-hero_platform.jpeg'),
  }} 
  header={translate({message: "Hana.eco, a Flexible Sustainability Platform"})}
  tagline={translate({message: "Carbon and air pollution data management"})}
  button={
