...
hero:
  header: "Partnership"
  tagline: ["We grow together through the synergy of connection."]
---
...
import * as data from "../data/ko_partnership.data";

<Hero background={{
    imageUrl: useBaseUrl('/images/bg-hero_partnership.jpeg'),
  }} 
  header={translate({message: "Partnership"})}
  tagline={translate({message: "We grow together through the synergy of connection"})}
  button={
