...
export async function InsightHeroSection({ locale }: { locale: AppLocale }) {
    ...
    return (
        <section className="relative h-[300px] overflow-hidden md:h-[360px] lg:h-[360px] xl:h-[360px] 2xl:h-[360px]" aria-label="HanaLoop Insight Hero">
            <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/site/docs/hero-bg.png')" }} />

            <div className="relative mx-auto flex h-full w-full max-w-[1440px] flex-col items-center justify-center px-4 md:pt-10 lg:pt-20 text-white">
                ...
                <Link
                    ...
                    className="mt-6 h-[48px] lg:mt-12 inline-flex min-w-[180px] items-center justify-center gap-3 rounded-full border border-white px-6 text-base font-medium leading-none text-white transition hover:bg-white/10"
                >
